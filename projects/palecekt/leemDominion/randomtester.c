...
int main(){
    ...
    for(int i = 0; i < NUM_BARON_TESTS; i++){
        ...
        int choice1 = rand() % 2;
        baronCardEffect(baron, choice1, -1, -1, &test, handPos, 0, 0);
    ...
    for(int i = 0; i < NUM_MINION_TESTS; i++){
        ...
        minionCardEffect(minion, choice1, choice2, -1, &test, handPos, 0, 0);
    ...
    for(int i = 0; i < NUM_AMBASSADOR_TESTS; i++){
        ...
        choice1++;
        int choice2 = rand() % 4;
        ambassadorCardEffect(ambassador, choice1, choice2, -1, &test, handPos, 0, 0);
    ...
    for(int i = 0; i < NUM_TRIBUTE_TESTS; i++){
        ...
        tributeCardEffect(tribute, -1, -1, -1, &test, handPos, 0, 0, 1);
    ...
    for(int i = 0; i < NUM_MINE_TESTS; i++){
        ...
        mineCardEffect(mine, choice1, choice2, -1, &test, handPos, 0, 0);
